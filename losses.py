...
class FocalLoss(nn.Module):
    ...
    def forward(self, classifications, regressions, anchors, annotations):
        ...
        #print ("clasif:", classifications.shape, "reg:", regressions.shape, "anchors:", anchors.shape, "anno:", annotations.shape)
        #print (classifications.is_cuda, regressions.is_cuda, anchors.is_cuda, annotations.is_cuda)
        ...
        for j in range(batch_size):
            ...
            if positive_indices.sum() > 0:
                ...
                #positive_indices = map(int, positive_indices)
                #import torch
